...
export const InputArea = ({onAdd}) => {
  ...
  const [titleField, setTitleField] = ("");
  // Crie um state de valuefield começando com 0.
  const [valueField, setValueField] = (0);
 ...
 function handleAddEvent() {
  ...
  if(dateField === ""){
    errors.push("Preencha uma data");
  }

  if(categoryField === ""){
    errors.push("Preencha uma categoria");
  }
  ...
  if(valueField === ""){
    errors.push("Preencha um volume");
  }
